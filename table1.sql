...
ALTER TABLE clinic_contacts
    ADD CONSTRAINT fk_clinic_contacts_clinic_id FOREIGN KEY (clinic_contacts)
...
ALTER TABLE employees
    ADD CONSTRAINT fk_employees_employee_clinic_id FOREIGN KEY (employees)
        REFERENCES clinic (clinic_id)
